...
export type Mutation_Root = {
  ...
  /** update multiples rows of table: "profile_user" */
  update_profile_user_many?: Maybe<Array<Maybe<Profile_User_Mutation_Response>>>;
...
/** mutation root */
export type Mutation_RootUpdate_Profile_User_ManyArgs = {
  updates: Array<Profile_User_Updates>;
};
...
export type Profile_User_Aggregate_Bool_Exp = {
  count?: InputMaybe<Profile_User_Aggregate_Bool_Exp_Count>;
};

export type Profile_User_Aggregate_Bool_Exp_Count = {
  arguments?: InputMaybe<Array<Profile_User_Select_Column>>;
  distinct?: InputMaybe<Scalars['Boolean']>;
  filter?: InputMaybe<Profile_User_Bool_Exp>;
...
/** on_conflict condition type for table "profile_user" */
...
/** Streaming cursor of the table "profile_user" */
export type Profile_User_Stream_Cursor_Input = {
  /** Stream column input with initial value */
  initial_value: Profile_User_Stream_Cursor_Value_Input;
  /** cursor ordering */
  ordering?: InputMaybe<Cursor_Ordering>;
};

/** Initial value of the column from where the streaming should start */
export type Profile_User_Stream_Cursor_Value_Input = {
  id?: InputMaybe<Scalars['uuid']>;
  profile_id?: InputMaybe<Scalars['uuid']>;
  user_id?: InputMaybe<Scalars['uuid']>;
};
...
export type Profile_User_Updates = {
  /** sets the columns of the filtered rows to the given values */
  _set?: InputMaybe<Profile_User_Set_Input>;
  /** filter the rows which have to be updated */
  where: Profile_User_Bool_Exp;
...
export type Profiles_Bool_Exp = {
  ...
  profile_users_aggregate?: InputMaybe<Profile_User_Aggregate_Bool_Exp>;
  user?: InputMaybe<Users_Bool_Exp>;
};
...
export type Subscription_Root = {
  ...
  /** fetch data from the table: "profile_user" using primary key columns */
  profile_user_by_pk?: Maybe<Profile_User>;
  /** fetch data from the table in a streaming manner: "profile_user" */
  profile_user_stream: Array<Profile_User>;
  /** fetch data from the table: "profiles" */
  profiles: Array<Profiles>;
  /** fetch aggregated fields from the table: "profiles" */
  profiles_aggregate: Profiles_Aggregate;
...
export type Subscription_RootProfile_User_StreamArgs = {
  batch_size: Scalars['Int'];
  cursor: Array<InputMaybe<Profile_User_Stream_Cursor_Input>>;
  where?: InputMaybe<Profile_User_Bool_Exp>;
};
